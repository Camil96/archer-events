...
import { User as UserIcon, Mail, Camera, Globe, Bell, Save } from 'lucide-react';
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-1">JPG, PNG of GIF. Maximaal 2MB.</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                setPreferences({ ...preferences, language: e.target.value as 'nl' | 'en' })
              }
              className="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-archer-blue focus:border-archer-blue transition-colors duration-200"
            >
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-sm text-neutral-700">E-mail notificaties ontvangen</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-neutral-50 rounded-lg">
            ...
            <p className="text-xs text-neutral-600">{user.is_active ? 'Actief' : 'Inactief'}</p>
          </div>
          <div className="text-center p-4 bg-neutral-50 rounded-lg">
